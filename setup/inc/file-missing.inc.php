...
?>
    <div id="main" class="file-missing"><!--osta-->
            ...
            <h3><?php echo __('Solution');?><!--osta--><br><font color="red"><?php echo $errors['err']; ?></font></h3>
            ...
            <ul>
                ...
                <!--osta-->
                <li><b><?php echo __('FTP');?>/<?php echo __('Cpanel');?></b><br><?php echo sprintf(__('If sample config file is missing - please make sure you uploaded all files in \'upload\' folder or refer to the %1$s Installation Guide %2$s'),'<a target="_blank" href="https://docs.osticket.com/en/latest/Getting%20Started/Installation.html">','</a>');?></li>
            </ul>
            <p><!--osta--></p>
            <div id="bar">
