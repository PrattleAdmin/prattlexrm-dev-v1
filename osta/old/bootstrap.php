...
class Bootstrap {
    ...
    static function loadConfig() {
        #load config info
        $configfile='';
        if(file_exists(OSTA_INCLUDE_DIR.'ost-config.php')) //NEW config file v 1.6 stable ++
            $configfile=OSTA_INCLUDE_DIR.'ost-config.php';
        elseif(file_exists(ROOT_DIR.'ostconfig.php')) //Old installs prior to v 1.6 RC5
            $configfile=INCLUDE_DIR.'ostconfig.php';
...
define('OSTA_INCLUDE_DIR', ROOT_DIR . '../../include/');
...
define('I18N_DIR', OSTA_INCLUDE_DIR.'i18n/');
